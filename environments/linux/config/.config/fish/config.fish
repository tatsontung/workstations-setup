...
set -Ua fish_user_paths $HOME/bin
set -Ua fish_user_paths $HOME/bin/jav/bin
set -Ua fish_user_paths /var/lib/snapd/snap/bin
set -x GOROOT $HOME/sdk/go
...
# Apply .profile
bass source ~/.profile
bass source ~/.config/bash.d/alias.fasd.sh
bass source ~/.config/bash.d/alias.common.sh
#alias v="f -e vim"
#bass source ~/.aliasrc
